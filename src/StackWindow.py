...
class StackWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.initUI()
        self.MainMenuInterface.settings_window.theme1.clicked.connect(
            self.theme_clicked
        )
        self.MainMenuInterface.settings_window.theme2.clicked.connect(
            self.theme_clicked
        )
        self.MainMenuInterface.settings_window.theme3.clicked.connect(
            self.theme_clicked
        )
        self.MainMenuInterface.settings_window.numpad_toggle.clicked.connect(
            self.UltimateTicTacToeInterface.toggle_numpad_control
        )
